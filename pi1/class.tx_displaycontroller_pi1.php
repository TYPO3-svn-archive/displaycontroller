 ...
 */
class tx_displaycontroller_pi1 extends tslib_pibase {
	var $prefixId      = 'tx_displaycontroller_pi1';		// Same as class name
	var $scriptRelPath = 'pi1/class.tx_displaycontroller_pi1.php';	// Path to this script relative to the extension dir.
